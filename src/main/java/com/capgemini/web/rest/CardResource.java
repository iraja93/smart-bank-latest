...
public class CardResource {
    ...
    @RequestMapping(value = "/getCardsByAccountId/{accountId}",
            method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE)
        @Timed
        public List<Card> getCardsByAccountId(@PathVariable Long accountId) {
            log.debug("REST request to get Card : {}", accountId);
            List<Card> cards= cardRepository.findOneByBAccountId(accountId);
            return cards;
        }
